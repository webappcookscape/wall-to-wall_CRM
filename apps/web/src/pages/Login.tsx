              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    id="login_pass"
                    name="login_pass"
                    className="w-full px-4 py-2 pr-11 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"

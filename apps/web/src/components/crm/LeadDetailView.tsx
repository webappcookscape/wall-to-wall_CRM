        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-y-5 gap-x-6">
           ...
           <div className="space-y-1">
            ...
            <div className="space-y-1.5 col-span-2 md:col-span-3 mt-1">
              ...
              <p className="text-sm md:text-base font-medium text-gray-800 bg-white p-3.5 rounded-xl border border-gray-200/80 italic leading-relaxed m-0">{lead.instructionToPass || 'No instructions provided'}</p>
            </div>
